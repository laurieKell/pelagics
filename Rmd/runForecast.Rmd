...
```{r}
ggplot(refs)+
  geom_line(aes(assessmentyear,flim),col="red")+
  geom_line(aes(assessmentyear,fpa), col="orange")+
  geom_line(aes(assessmentyear,fmsy),col="green")+
...
```{r}
ggplot(refs)+
  geom_line(aes(assessmentyear,blim),       col="red")+
  geom_line(aes(assessmentyear,bpa),        col="orange")+
  geom_line(aes(assessmentyear,msybtrigger),col="green")+
  facet_grid(spp~.,scale="free")+
