...
library(mpb)    #remotes::install_github("lauriekell/mpb")
...
```{r, assessment, fig.width=12,fig.height=6}
library(ggpubr)
...
**Figure `r iFig=iFig+1; iFig`** Comparison of ICES assessments with VPA, and projection with reported catches. 
