...
```{r, refs, fig.width=10,fig.height=6}
refplots <- list()
...
Most recent assessments (2022) and historical estimates of reference points. 

```{r, assessment, fig.width=10,fig.height=12}
...
Note the difference in recruitment between ICES assessment and VPA reconstruction. This is due to the flexibility in SAM in deviating from the catch equation. 
...
```{r, hind, fig.width=10,fig.height=6}
library(ggpubr)
...
proj=list("whb"=plot(window(FLStocks("Fmsy"=whbFwd,"Fmsy 2021"=whbFwd2,"Status Quo"=whb),start=1990,end=2020))+
...
proj[["her"]]=plot(window(FLStocks("Fmsy"=herFwd,"Fmsy 2021"=herFwd2,"Status Quo"=her),start=1990,end=2020))+
  scale_colour_manual("Scenario",values=c("red","blue","orange"))+
  theme_bw()+ 
  theme(legend.position="bottom")
```
...
proj[["mac"]]=plot(window(FLStocks("Fmsy"=macFwd,"Fmsy 2021"=macFwd2,"Status Quo"=mac),start=1990,end=2020))+
  scale_colour_manual("Scenario",values=c("red","blue","orange"))+
  theme_bw()+
  theme(legend.position="bottom")
```
...
```{r, proj, fig.width=10,fig.height=6}
library(ggpubr)  
...
```{r, retro, fig.width=10,fig.height=3}
library(ggpubr)  
