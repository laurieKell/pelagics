...
load("/home/laurie/Desktop/projects/pelagics/data/inputs/MAC/model fit.RData")
...
```{r}
save(assessment,file="~/Desktop/tmp/t.RData")
```
...
```{r, whb-fmsy}
load("/home/laurie/Desktop/projects/pelagics/data/inputs/WHB/run/model.RData")
...
load("/home/laurie/Desktop/projects/pelagics/data/inputs/HER/NSAS_HAWG2022_sf_replicates.RData")
...
```{r, runWhb}
stk="whb" 
source("/home/laurie/Desktop/projects/pelagics/run/runHcr.R") 
```
...
```{r, smry, cache=FALSE}
source("~/Desktop/projects/pelagics/R/pm.R") 
