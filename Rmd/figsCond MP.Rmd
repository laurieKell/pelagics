...
whbC=plot(FLQuants(llply(sims[-1],function(x) catch(window(x[[1]],start=2000,end=2021)))))+
  geom_line(aes(year,data),data=as.data.frame(catch(sims[[1]][[1]])[,ac(2000:2021)]),col="red")+facet_wrap(~qname)
...
p1 <-
  plot(
  FLQuants(llply(sims[c("HCR1 bnd","HCR1 +10% bnd", "HCR1 +20% bnd", "HCR1 +30% bnd")],
                 function(x) catch(window(x[[1]],start=2000,end=2021)))))+
  geom_line(data=as.data.frame(catch(sims[[1]][[1]])[,ac(2000:2021)]),
            aes(year,data), 
            col="blue", size=1) +
...
# References
>>>>>>> 4752e956e09a6932f23a908b3a45beceace1d43d
