...
#### Blue whiting: comparing different HCR’s without TAC bounds
...
#### Blue whiting: comparing different HCR’s with and without TAC bounds
...
#### Blue whiting: comparing HCR’s with and without a cap on TAC bounds
...
#### Blue whiting: comparing HCR’s with and without implementation error (without bounds on TAC change)
...
#### Blue whiting: comparing HCR’s with and without implementation error in combination with bounds on TAC change
...
#### Blue whiting: comparing all scenario's on median catch, IAV and AAV
